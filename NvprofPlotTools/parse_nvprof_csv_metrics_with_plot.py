...
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('IPC', fontsize='x-large')

plt.grid()
plt.xticks(index + bar_width, benchmark_list, fontsize='x-large')
...
rects2 = plt.bar(index + bar_width, bwd_occupancy, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('Achieved Occpancy', fontsize='x-large')
plt.ylim((0, 1))
...
rects2 = plt.bar(index + bar_width, bwd_l1_shared_utilization, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('L1/Shared Utilization', fontsize='x-large')
plt.ylim((0, 10))
...
rects2 = plt.bar(index + bar_width, bwd_l2_utilization, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('L2 Utilization', fontsize='x-large')
plt.ylim((0, 10))
...
rects2 = plt.bar(index + bar_width, bwd_dram_utilization, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('DRAM Utilization', fontsize='x-large')
plt.ylim((0, 10))
...
rects2 = plt.bar(index + bar_width, bwd_alu_fu_utilization, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('ALU Utilization', fontsize='x-large')
plt.ylim((0, 10))
...
rects2 = plt.bar(index + bar_width, bwd_ldst_fu_utilization, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('Load/Store Unit Utilization', fontsize='x-large')
plt.ylim((0, 10))
...
rects2 = plt.bar(index + bar_width, bwd_eligible_warps, bar_width,
                 ...
                 label='Backward propagation')
plt.xlabel('Benchmarks', fontsize='x-large')
plt.ylabel('Eligible Warps Per Cyle', fontsize='x-large')
plt.ylim((0, 10))
